    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._connect_lock = asyncio.Lock()
          ...
          # now reaches self.mcp.tool() instead of self.add_tool().
        register_generic_tools(self, type(self).generic_tools)

# !!!!!!!!!!!!!!!!!!!!!!!! Architectural reason: a clean port should leave domain logic untouched!!!!!!!!!!!!!!!!!!!!!!1
    ...
    def run(self, transport: str = "stdio") -> None:  # type: ignore[override]
        ...
        # for macaw transport does not matter
        self.mcp.run()